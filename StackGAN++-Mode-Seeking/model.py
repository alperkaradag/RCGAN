...
class INCEPTION_V3(nn.Module):
    def __init__(self):
        ...
        path = "C:\\Users\\alper\\PycharmProjects\\MSGAN\\StackGAN++-Mode-Seeking\\models\\inception_v3_google-1a9a5a14.pth"
...
# For Frechet Inception Distance calculation
# Adapted from https://github.com/mseitzer/pytorch-fid
class FID_INCEPTION(nn.Module):
    def __init__(self):
        super(FID_INCEPTION, self).__init__()
        ...
        # all_blocks = block0 + block1 + block2 + block3
        # self.blocks.append(nn.Sequential(*all_blocks))
...
def fid_inception_v3():
    ...
    """
    print("Building FID inception network")
    ...
    path = "C:\\Users\\alper\\PycharmProjects\\MSGAN\\StackGAN++-Mode-Seeking\\models\\pt_inception-2015-12-05-6726825d.pth"
    print('Loading pretrained model from ', path)
    state_dict = torch.load(path)
